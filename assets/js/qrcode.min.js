...
(function (global) {
  ...
  QRCode.prototype = {
    addData: function (data) {
      var newData = new QRMode8bitByte(data);
    ...
    renderTo2dContext: function (context, cellSize) {
      for (var row = 0; row < this.getModuleCount(); row++) {
        for (var col = 0; col < this.getModuleCount(); col++) {
          context.fillStyle = this.isDark(row, col) ? "#000" : "#fff";
  ...
  var QRMode8bitByte = function (data) {
    this.mode = QRMode.MODE_8BIT_BYTE;
    this.data = data;
  };

  QRMode8bitByte.prototype = {
  ...
  global.QRCode = function (element, options) {
    ...
    var qr = new QRCode(4, settings.correctLevel);
    qr.addData(settings.text);
    qr.make();

    element.innerHTML = qr.createTableTag(
      settings.width / qr.getModuleCount(),
      0
    );
  ...
  global.QRCode.CorrectLevel = QRErrorCorrectLevel;
})(this);
